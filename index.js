...
class App extends Component {
  ...
  */
  encryptAES = (text, key) => {
    ...
    const encryptInfo = CryptoJS.AES.encrypt(text, CryptoJS.enc.Utf8.parse(atob("b3c3ZHh5czhnbGZvcjl0bmMyYW5zZGZvMWV0a2ZqY3Y=")), {
      iv: CryptoJS.enc.Utf8.parse(atob("cW8xbGMzc2pkOHpwdDljeA==")),
      padding: CryptoJS.pad.Pkcs7,
      mode: CryptoJS.mode.CBC
    })


    return encryptInfo.toString()
   ...
   */
  decryptAES = (encryptedBase64, key1) => {

    const key = atob("b3c3ZHh5czhnbGZvcjl0bmMyYW5zZGZvMWV0a2ZqY3Y=");
    const iv = atob("cW8xbGMzc2pkOHpwdDljeA==");
